...
local MAJOR, MINOR = "LibBossIDs-1.0", "$Revision: 120 $"
...
local BossIDs = {
	...
	-------------------------------------------------------------------------------
	-- Assault on Violet Hold (Legion-Dungeon)
	-------------------------------------------------------------------------------
	...
	-------------------------------------------------------------------------------
	-- Black Rook Hold (Legion-Dungeon)
	-------------------------------------------------------------------------------
	...
	-------------------------------------------------------------------------------
	-- Darkheart Thicket (Legion-Dungeon)
	-------------------------------------------------------------------------------
	...
	-------------------------------------------------------------------------------
	-- Neltharion's Lair (Legion-Dungeon)
	-------------------------------------------------------------------------------
	[91003] = true, -- Rokmora
	...
	-------------------------------------------------------------------------------
	-- Return to Karazhan (Legion-Dungeon)
	-------------------------------------------------------------------------------
	[114284] = true, -- Elfyra
	...
	-------------------------------------------------------------------------------
	-- Seat of the Triumvirate (Legion-Dungeon)
	-------------------------------------------------------------------------------
	...
	-------------------------------------------------------------------------------
	-- Vault of the Wardens (Legion-Dungeon)
	-------------------------------------------------------------------------------
	...
	-------------------------------------------------------------------------------
	-- Antorus, the Burning Throne (Legion-Raid 7.3)
	-------------------------------------------------------------------------------
	...
	[150013] = true, -- Elisande

	-- Betrayer's Rise
	[105503] = true, -- Gul'dan

	-------------------------------------------------------------------------------
	-- Tomb of Sargeras (Legion-Raid 7.2.5)
	-------------------------------------------------------------------------------
	-- The Gates of Hell
	[115844] = true, -- Goroth
	...
	-------------------------------------------------------------------------------
	-- The Emerald Nightmare (Legion-Raid 7.0)
	-------------------------------------------------------------------------------
	-- Darkbough
	...
	-------------------------------------------------------------------------------
	-- Trial of Valor (Legion-Raid 7.0)
	-------------------------------------------------------------------------------
	-- [114263] = true, -- Odyn
	[114344] = true, -- Guarm
	[114537] = true, -- Helya
	...
	-------------------------------------------------------------------------------
	-- Operation: Mechagon (BfA-Dungeon)
	-------------------------------------------------------------------------------
	...
	-------------------------------------------------------------------------------
	-- Atal'Dazar (BfA-Dungeon)
	-------------------------------------------------------------------------------
	[129614] = true, -- Priestess Alun'za
	[129399] = true, -- Vol'kaal
	[143577] = true, -- Rezan
	[129412] = true, -- Yazma

	-------------------------------------------------------------------------------
	-- Freehold (BfA-Dungeon)
	-------------------------------------------------------------------------------
	[129732] = true, -- Skycap'n Kragg
	[129431] = true, -- Captain Eudora
	[129440] = true, -- Harlan Sweete
	[126969] = true, -- Trothak -- needs review
	[129412] = true, -- Yazma

	-------------------------------------------------------------------------------
	-- Shrine of the Storm (BfA-Dungeon)
	-------------------------------------------------------------------------------
	[134056] = true, -- Aqu'sirr
	[134058] = true, -- Galecaller Faye
	[134063] = true, -- Brother Ironhull
	[139737] = true, -- Lord Stormsong
	[134069] = true, -- Vol'zith the Whisperer

	-------------------------------------------------------------------------------
	-- The MOTHERLODE!! (BfA-Dungeon)
	-------------------------------------------------------------------------------
	...
	-------------------------------------------------------------------------------
	-- Temple of Sethraliss (BfA-Dungeon)
	-------------------------------------------------------------------------------
	[133379] = true, -- Adderis
	...
	-------------------------------------------------------------------------------
	-- The Underrot (BfA-Dungeon)
	-------------------------------------------------------------------------------
	[131318] = true, -- Elder Leaxa
	[131817] = true, -- Cragmaw the Infested
	[131383] = true, -- Sporecaller Zancha
	[133007] = true, -- Unbound Abomination

	-------------------------------------------------------------------------------
	-- Tol Dagor (BfA-Dungeon)
	-------------------------------------------------------------------------------
	...
	-------------------------------------------------------------------------------
	-- Siege of Boralus (BfA-Dungeon)
	-------------------------------------------------------------------------------
	[144160] = true, -- Chopper Redhook
	[144158] = true, -- Sergeant Bainbridge
	[129208] = true, -- Dread Captain Lockwood
	[130836] = true, -- Hadal Darkfathom
	[128652] = true, -- Viq'Goth

	-------------------------------------------------------------------------------
	-- Battle of Dazar'alor (BfA-Raid 8.1)
	-------------------------------------------------------------------------------
	-- Alliance
	[144683] = true, -- Ra'wani Kanae
	[148238] = true, -- Ma'ra Grimfang
	[146100] = true, -- Anathos Firecaller
	[144638] = true, -- Grong the Revenant
	[145261] = true, -- Opulence
	[144747] = true, -- Pa'ku's Aspect
	...
	[165396] = true, -- Lady Jaina Proudmoore

	-------------------------------------------------------------------------------
	-- Ny'alotha, the Waking City (BfA-Raid 8.3)
	-------------------------------------------------------------------------------
	...
	[157254] = true, -- Tek'ris
	[157231] = true, -- Shad'har the Insatiable
	[157602] = true, -- Drest'agath
	[158328] = true, -- Il'gynoth
	[157354] = true, -- Vexiona
	[156866] = true, -- Ra-den
	[157439] = true, -- Fury of N'Zoth
	[158041] = true, -- N'Zoth the Corruptor
	...
	-------------------------------------------------------------------------------
	-- The Eternal Palace (BfA-Raid 8.2)
	-------------------------------------------------------------------------------
	...
	-------------------------------------------------------------------------------
	-- Crucible of Storms (BfA-Raid 8.1)
	-------------------------------------------------------------------------------
	[146497] = true, -- Zaxasj the Speaker
	[145371] = true, -- Uu'nat

	-------------------------------------------------------------------------------
	-- Darkmaul Citadel (Shadowlands-Dungeon)
	-------------------------------------------------------------------------------
	[157300] = true, -- Tunk
	[156814] = true, -- Gor'groth

	-------------------------------------------------------------------------------
	-- The Necrotic Wake (Shadowlands-Dungeon)
	-------------------------------------------------------------------------------
	...
	-------------------------------------------------------------------------------
	-- Plaguefall (Shadowlands-Dungeon)
	-------------------------------------------------------------------------------
	...
	-------------------------------------------------------------------------------
	-- Mists of Tirna Scithe (Shadowlands-Dungeon)
	-------------------------------------------------------------------------------
	[164567] = true, -- Ingra Maloch
	[170217] = true, -- Ingra Maloch
	[164517] = true, -- Tred'ova

	-------------------------------------------------------------------------------
	-- Halls of Atonement (Shadowlands-Dungeon)
	-------------------------------------------------------------------------------
	[165408] = true, -- Halkias
	[156827] = true, -- Echelon
	...
	-------------------------------------------------------------------------------
	-- De Other Side (Shadowlands-Dungeon)
	-------------------------------------------------------------------------------
	[166473] = true, -- Hakkar the Soulflayer
	-- [101976] = true, -- Millificent Manastorm
	[164450] = true, -- Dealer Xy'exa
	[169769] = true, -- Mueh'zala

	-------------------------------------------------------------------------------
	-- Sanguine Depths (Shadowlands-Dungeon)
	-------------------------------------------------------------------------------
	...
	-------------------------------------------------------------------------------
	-- Spires of Ascension (Shadowlands-Dungeon)
	-------------------------------------------------------------------------------
	...
	-------------------------------------------------------------------------------
	-- Theater of Pain (Shadowlands-Dungeon)
	-------------------------------------------------------------------------------
	[164451] = true, -- Dessia the Decapitator
	[164463] = true, -- Paceran the Virulent
	[164461] = true, -- Sathel the Accursed
	[162317] = true, -- Gorechop
	[162329] = true, -- Xav the Unfallen
	[162309] = true, -- Kul'tharok
	[165946] = true, -- Mordretha, the Endless Empress

	-------------------------------------------------------------------------------
	-- Tazavesh, the Veiled Market (Shadowlands-Dungeon)
	-------------------------------------------------------------------------------
	[175616] = true, -- Zo'phex
	[176556] = true, -- Alcruux
	[176564] = true, -- Zo'gron
	...
	[175546] = true, -- Timecap'n Hooktail
	[177269] = true, -- So'leah

	-------------------------------------------------------------------------------
	-- Castle Nathria (Shadowlands-Raid)
	-------------------------------------------------------------------------------
	[172145] = true, -- Shriekwing
	[165066] = true, -- Huntsman Altimor
	[165759] = true, -- Kael'thas Sunstrider
	[166644] = true, -- Artificer Xy'mox
	...
	-------------------------------------------------------------------------------
	-- Sanctum of Domination (Shadowlands-Raid)
	-------------------------------------------------------------------------------
	...
	[175559] = true, -- Kel'Thuzad
	[175732] = true, -- Sylvanas Windrunner

	-------------------------------------------------------------------------------
	-- Dawn of the Infinite (Dragonflight-Dungeon)
	-------------------------------------------------------------------------------
	[198995] = true, -- Chronikar
	[206238] = true, -- Manifested Timeways
	[207639] = true, -- Blight of Galakrond
	[194907] = true, -- Iridikron the Stonescaled
	[198998] = true, -- Tyr, the Infinite Keeper
	[202789] = true, -- Morchie
	[209207] = true, -- Time-Lost Battlefield
	[209208] = true, -- Time-Lost Battlefield
	[199000] = true, -- Chrono-Lord Deios

	-------------------------------------------------------------------------------
	-- Ruby Life Pools (Dragonflight-Dungeon)
	-------------------------------------------------------------------------------
	[188252] = true, -- Melidrussa Chillworn
	[189232] = true, -- Kokia Blazehoof
	[199790] = true, -- Kyrakka and Erkhart Stormvein

	-------------------------------------------------------------------------------
	-- The Nokhud Offensive (Dragonflight-Dungeon)
	-------------------------------------------------------------------------------
	[186616] = true, -- Granyth
	[186615] = true, -- The Raging Tempest
	[195723] = true, -- Teera
	[186338] = true, -- Maruuk
	[186151] = true, -- Balakar Khan

	-------------------------------------------------------------------------------
	-- Brackenhide Hollow (Dragonflight-Dungeon)
	-------------------------------------------------------------------------------
	[186122] = true, --Hackclaw's War-Band
	[186120] = true, --Treemouth
	[186116] = true, --Gutshot
	[186121] = true, --Decatriarch Wratheye

	-------------------------------------------------------------------------------
	-- Halls of Infusion (Dragonflight-Dungeon)
	-------------------------------------------------------------------------------
	[189719] = true, -- Watcher Irideus
	[189722] = true, -- Gulping Goliath
	[189727] = true, -- Khajin the Unyielding
	[189729] = true, -- Primal Tsunami

	-------------------------------------------------------------------------------
	-- The Azure Vault (Dragonflight-Dungeon)
	-------------------------------------------------------------------------------
	[186644] = true, -- Leymor
	[186739] = true, -- Azureblade
	[199614] = true, -- Telash Greywing
	[186738] = true, -- Umbrelskul
	...
	-------------------------------------------------------------------------------
	-- Neltharus (Dragonflight-Dungeon)
	-------------------------------------------------------------------------------
	[189340] = true, -- Chargath, Bane of Scales
	[189478] = true, -- Forgemaster Gorek
	[181861] = true, -- Magmatusk
	[189901] = true, -- Warlord Sargha

	-------------------------------------------------------------------------------
	-- Uldaman (Dragonflight-Dungeon)
	-------------------------------------------------------------------------------
	-- [6906] = true, -- Baelog
	[6907] = true, -- Eric "The Swift"
	[6908] = true, -- Olaf
	[184018] = true, -- Bromach
	[184124] = true, -- Sentinel Talondras
	[184422] = true, -- Emberon
	[184125] = true, -- Chrono-Lord Deios

	-------------------------------------------------------------------------------
	-- Aberrus, the Shadowed Crucible (Dragonflight-Raid)
	-------------------------------------------------------------------------------
	...
	[201668] = true, -- Neltharion
	[201754] = true, -- Sarkareth

	-------------------------------------------------------------------------------
	-- Amirdrassil, the Dream's Hope (Dragonflight-Raid)
	-------------------------------------------------------------------------------
	[209333] = true, -- Gnarlroot
	[200926] = true, -- Igira the Cruel
	[208478] = true, -- Volcoross
	[208363] = true, -- Urctos (Council of Dreams)
	[208365] = true, -- Aerwynn (Council of Dreams)
	[213390] = true, -- Pip (Council of Dreams)
	[208445] = true, -- Larodar, Keeper of the Flame
	...
	-------------------------------------------------------------------------------
	-- Vault of the Incarnates (Dragonflight-Raid)
	-------------------------------------------------------------------------------
	[184972] = true, -- Eranog
	[190496] = true, -- Terros
	[187771] = true, -- Kadros Icewrath (The Primal Council)
	[187768] = true, -- Dathea Stormlash (The Primal Council)
	[187772] = true, -- Opalfang (The Primal Council)
	[187767] = true, -- Embar Firepath (The Primal Council)
	[187967] = true, -- Sennarth, the Cold Breath
	[189813] = true, -- Dathea, Ascended
	[181378] = true, -- Kurog Grimtotem
	[190245] = true, -- Broodkeeper Diurna
	[189492] = true, -- Raszageth the Storm-Eater
}
